...
<span style="font-weight:bold; color:#E34234;">*中国电机工程学报*</span>



- 基于CFD和Matlab平台，建立了超临界切圆锅炉炉内燃烧与高温受热面换热的耦合模型，实现了壁温与热流在风烟侧和汽水侧的迭代计算。
- 针对不同管屏的形状特点，提出了Fluent结构和非结构化网格与Matlab离散微元的映射方法。特别对于三角网格划分的复杂壁面，通过建立辅助网格，提高了汽水模型解析 Fluent 网格信息的速度，协调了耦合过程中2个分布参数模型的计算时间。
